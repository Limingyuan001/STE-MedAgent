...
# from .utils import load_eurorad_dataset
# from .llm import get_llm_response

# Constants
DATA_DIR = "D:/Projects/MedRAXlmy/MedRAX/data" # "set your data directory here, e.g. /home/MedRAX/data"
...
def main():
    ...
    if not api_key:
        raise ValueError("OPENAI_API_KEY or DASHSCOPE_API_KEY environment variable is not set.")
    ...
    generate_questions(
        dataset=dataset,
        client=client,
        output_dir="benchmark/questions",
        model=model,
    )
